...
import { Users, FileText, CheckSquare, ReceiptText, ArrowUpRight, ArrowDownRight } from "lucide-react"
  ...
  return (
    <div className="flex flex-col gap-8 pb-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Overview of procurement activities and pending tasks.</p>
      </div>
      ...
      >
        <div className="rounded-xl border bg-card text-card-foreground shadow-sm col-span-4">
          <div className="flex flex-col space-y-1.5 p-6">
            <h3 className="font-semibold leading-none tracking-tight">Recent Procurement Activities</h3>
