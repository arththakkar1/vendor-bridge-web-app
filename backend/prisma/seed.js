...
async function main() {
    ...
    for (const roleName of ['ADMIN', 'OFFICER', 'VENDOR', 'MANAGER']) {
    ...
    const usersData = [
        { name: 'Admin User', email: 'admin@vendorbridge.com', role: 'ADMIN' },
        { name: 'Procurement Officer', email: 'officer@vendorbridge.com', role: 'OFFICER' },
        { name: 'Manager User', email: 'manager@vendorbridge.com', role: 'MANAGER' },
        { name: 'Vendor User', email: 'vendor@infra-supplies.com', role: 'VENDOR' },
    ];
